require('should')
const buildOptionsForUnlikeMedia = require('../src/shared-functions/build-options-for-unlike-media')
...
describe('build options for get media', () => {
  it('should return options with json:true', (done) => {
    ...
    assert(buildOptionsForUnlikeMedia(defaultOptions, accessToken))
  })
